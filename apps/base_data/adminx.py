...
class StockLimitUpDetailAdmin(BaseQueryAdmin):
    list_display = ['trade_date', 'stock_code', 'stock_name', 'limit_up_days_color', 'cap', 'limit_up_reasons_hot', 'limit_up_reasons', 'limit_up_type', 'first_limit_up_time', 'cb', 'update_datetime']

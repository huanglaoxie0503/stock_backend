...
class StockLimitBlast(BaseModel):
    ...
    limit_up_opened_cnt = models.IntegerField(default=1, verbose_name='涨停开板次数', help_text='涨停开板次数')
    limit_up_duration = models.CharField(max_length=20, null=True, blank=True, verbose_name="涨停封板时长", help_text="涨停封板时长")
    first_limit_up_time = models.TimeField(null=True, blank=True, verbose_name="首次涨停时间", help_text="首次涨停时间")
    pre_close = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True, verbose_name='收盘价格', help_text='收盘价格')

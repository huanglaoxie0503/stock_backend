...
class BaseStockModel(BaseModel):
    ...
    open_price = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='开盘价',
                                     help_text='开盘价')
    pre_close = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='昨收价',
                                    help_text='昨收价')
    pre_open_vol_ratio = models.DecimalField(max_digits=4, decimal_places=2, null=True, blank=True,
                                             verbose_name='天量比', help_text='集合竞价成交量/昨日成交量（比率）')
    ...
    auction_amount = models.DecimalField(max_digits=15, decimal_places=2, null=True, blank=True,
                                         verbose_name='竞价金额', help_text='集合竞价成交金额')
    auction_volume = models.BigIntegerField(null=True, blank=True, verbose_name='竞价量', help_text='集合竞价成交量')
    pre_max_volume = models.BigIntegerField(null=True, blank=True, verbose_name='成交量(Max)',
...
class StockAuction(BaseModel):
    ...
    limit_up_order_amount = models.DecimalField(max_digits=15, decimal_places=2, null=True, blank=True,
                                                verbose_name='竞价封单(亿)', help_text='涨停封单金额')
    cap = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='市值(亿)',
                              help_text='自由流通市值')
    limit_up_reason = models.CharField(max_length=255, null=True, blank=True, verbose_name="涨停归因",
                                       help_text="涨停原因")
    vol_diff_20_25 = models.IntegerField(default=0, verbose_name='T_20(万手)', help_text='20-25量差(万手)')
    vol_diff_24_25 = models.IntegerField(default=0, verbose_name='T_24(手)', help_text='24-25量差(手)')
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['trade_date', 'stock_code'],
                                    name='unique_trade_date_stock_code_limit_up_auction')]
...
class StockAuctionConditions(BaseStockModel):
    high_price = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='最高价',
                                     help_text='最高价')
    gap_type = models.CharField(max_length=20, null=True, blank=True, verbose_name="高开类型", help_text="高开类型")
    cond_name = models.CharField(max_length=50, null=True, blank=True, verbose_name="选股条件",
                                 help_text="选股条件名称")
...
class AuctionAggressiveBuyingDetail(BaseModel):
    ...
    vol_diff_20_25 = models.IntegerField(default=0, verbose_name='diff_20', help_text='20-25量差(万手)')
    vol_diff_24_25 = models.IntegerField(default=0, verbose_name='diff_24', help_text='24-25量差(万手)')
    buy_1_vol = models.IntegerField(default=0, verbose_name='买一(手)', help_text='买一量(手)')
    price_20 = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, verbose_name='20分价',
                                   help_text='20分价格')
    price_24 = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, verbose_name='24分价',
                                   help_text='24分价格')
    price_25 = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, verbose_name='25分价',
                                   help_text='25分价格')
    ...
    is_limit_up = models.CharField(default='N/A', max_length=20, null=True, blank=True, verbose_name='涨停',
                                   help_text='涨停')
    remark = models.CharField(default='N/A', max_length=50, null=True, blank=True, verbose_name='备注',
                              help_text='备注')

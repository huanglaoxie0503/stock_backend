...
class AuctionAggressiveBuyingDetail(BaseModel):
    ...
    vol_diff_20_25 = models.IntegerField(default=0, verbose_name='D_20(万手)', help_text='20-25量差(万手)')
    vol_diff_24_25 = models.IntegerField(default=0, verbose_name='D_24(手)', help_text='24-25量差(手)')

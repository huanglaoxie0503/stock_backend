...
class StockAuctionConditionsAdmin(BaseColorAdmin):
    list_display = ['trade_date_color', 'stock_code', 'stock_name', 'vol_ratio_color', 'vol_ratio_oa_color', 'cap', 'gap_type_color', 'cond_name', 'open_price', 'pre_close', 'high_price', 'profit_chg_color', 'profit_chg_close', 'is_ops', 'update_datetime']
